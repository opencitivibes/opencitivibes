    ...
    <div className="min-h-[60vh] flex items-center justify-center bg-gray-50 dark:bg-gray-900 px-4">
      <div className="max-w-md w-full text-center">
        ...
        <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">
          {t('errors.officialsError', 'Dashboard Error')}
        </h2>
        <p className="text-gray-600 dark:text-gray-400 mb-6">
          {t(
            'errors.officialsErrorDescription',
            'An error occurred loading the official dashboard. Please try again.'
          )}
        </p>
